...
const baseUrl = "https://ec2-16-171-153-216.eu-north-1.compute.amazonaws.com"
    ...
    switch (currentStep) {
      ...
      case 1:
        try {
          ...
          const practiceResponse = await fetch(
            baseUrl+"/api/buddhist-practices",
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
      ...
      case 2:
        try {
          ...
          // Second API call to create an address
          const addressResponse = await fetch(
            baseUrl+"/api/social-information",
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
          ...
          // First API call to create a Buddhist user
          const userResponse = await fetch(
            baseUrl+"/api/health-information",
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
