...
const RegistrationForm = () => {
  const userData = {
    ...
    addresses: [
      {
        addressId: 2,
        address: "6/D Upper Junction Yatadolawatte, Mathugama, Kaluthara",
        province: "Western",
        district: "Kaluthara",
        nearestTown: "Mathugama",
      },
    ],
    buddhistPractice: {
      practiceId: 2,
      origin: "SINCE_BIRTH",
      timeInvestedOverall: "MORE_50",
      deedCategoryDana: "NO",
      deedCategorySeela: "NO",
      deedCategoryBhavana: "NO",
      deedCategoryOther: "NO",
      meditationAnaPanaSathiTime: 10,
      meditationMayithreeTime: 20,
      bodyAwarenessTime: 30,
      meditationOtherTime: 25,
      meditationTeacher: "හත්තක ජිනරතන",
      seelaPansilTime: 10,
      seelaAtaSilTime: 20,
      seelaOtherTime: 30,
      danaAmountAnimals: 100,
      danaAmountPeople: 200,
      danaAmountSangha: 3000,
      sermonListenTime: 45,
      sermonSpeakersDetails: "Noe jro\nasd bgg",
      knowledgeAbhiDhamma: "NO",
      descriptionOfYourSelf: "adfadsf",
      enterToHardPractice: "NO",
      createdAt: "2024-08-28T09:12:39.125651Z",
      valueScore: null,
    },
    socialInformation: {
      socialInfoId: 2,
      marriageStatus: "SIGNATURE_ONLY",
      occupation: null,
      highestEducationQualification: null,
      monthlyIncome: 99998,
      houseOwnership: "NO_HOUSE",
      vehicleOwnership: "NO",
      createdAt: "2024-08-28T09:14:17.549Z",
    },
    userHealthInformation: {
      healthInfoId: 2,
      height: 5,
      weight: 64,
      physicalAttractiveness: "NORMAL",
      skinTone: "DARK",
      kidsExpectancy: 2,
      smoking: "YES",
      drugUsage: "YES",
      ...
      mentalHealth: "ADHD",
      geneticRisks: "No",
      yourMessage: "Thank you",
      createdAt: "2024-08-28T09:14:18.257Z",
    },
  };
